...
export const fetchWebsiteCurrentHeaders = createAsyncThunk<
  TemplateDocument[],
  { tenantId?: string | ObjectId; id?: string },
  { state: { header: HeaderState }; rejectValue: string }
>(
...
export const fetchHeaderById = createAsyncThunk<
  ...
  { id: string },
  { rejectValue: string }
>("header/fetchHeaderById", async ({ id }, { rejectWithValue }) => {
  try {
...
export const createHeader = createAsyncThunk<
  ...
  { rejectValue: string }
>("header/createHeader", async (headerData, { rejectWithValue }) => {
  try {
...
export const updateHeader = createAsyncThunk<
  ...
  { rejectValue: string }
>("header/updateHeader", async (headerData, { rejectWithValue }) => {
  try {
    const res = await fetch(`/api/admin/header`, {
      method: "PUT",
      headers: {
...
export const deleteHeader = createAsyncThunk<
  ...
  string,
  { rejectValue: string }
>("header/deleteHeader", async (id, { rejectWithValue }) => {
  try {
    const res = await fetch(`/api/admin/header`, {
      method: "DELETE",
      headers: {
