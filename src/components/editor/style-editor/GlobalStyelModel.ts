import { BodyStyle, BrandColors, ButtonBaseStyle, ButtonColors, HeadingStyle, HeadingKey, BtnKey } from "@/components/admin/settings/global-styles/GlobalStyleModal";
...
export const transformVarsToGlobalStyleModel = (vars: Record<string, string>): GlobalStyleModel => {
    ...
    return {
        ...
        headings: {
            h1: { scale: getNum(getVal('--h1-size', '43px'), 43), weight: getNum(getVal('--h1-weight', '800'), 800), lineHeight: getNum(getVal('--h1-lh', '1.05'), 1.05), letterSpacingEm: getNum(getVal('--h1-ls', '-0.03em'), -0.03) },
            h2: { scale: getNum(getVal('--h2-size', '34px'), 34), weight: getNum(getVal('--h2-weight', '800'), 800), lineHeight: getNum(getVal('--h2-lh', '1.1'), 1.1), letterSpacingEm: getNum(getVal('--h2-ls', '-0.02em'), -0.02) },
            h3: { scale: getNum(getVal('--h3-size', '26px'), 26), weight: getNum(getVal('--h3-weight', '700'), 700), lineHeight: getNum(getVal('--h3-lh', '1.15'), 1.15), letterSpacingEm: getNum(getVal('--h3-ls', '-0.01em'), -0.01) },
            h4: { scale: getNum(getVal('--h4-size', '21px'), 21), weight: getNum(getVal('--h4-weight', '700'), 700), lineHeight: getNum(getVal('--h4-lh', '1.2'), 1.2), letterSpacingEm: getNum(getVal('--h4-ls', '0em'), 0) },
            h5: { scale: getNum(getVal('--h5-size', '19px'), 19), weight: getNum(getVal('--h5-weight', '600'), 600), lineHeight: getNum(getVal('--h5-lh', '1.25'), 1.25), letterSpacingEm: getNum(getVal('--h5-ls', '0em'), 0) },
            h6: { scale: getNum(getVal('--h6-size', '17px'), 17), weight: getNum(getVal('--h6-weight', '600'), 600), lineHeight: getNum(getVal('--h6-lh', '1.3'), 1.3), letterSpacingEm: getNum(getVal('--h6-ls', '0.01em'), 0.01) },
        },
        fonts: {
