...
export function FormsPage(
    ...
    const handleTabControl = (tab: string) => {
        setTab(tab);
    }
    return (
        <div>
            ...
            >
                <PillTabs value={tab} onValueChange={(v) => handleTabControl(v)} />
            </div>
            ...
            <ScrollArea className=" border-b border-gray-200 mt-4 ">
                <div className="px-0 py-0">
                    ...
                    <div style={{ display: tab === "fields" ? "block" : "none" }}>
                        <CurrentForm
                        />
                    </div>

                    {/* BUTTON */}
                    <div style={{ display: tab === "button" ? "block" : "none" }} className="space-y-5">
                    ...
                    {/* STYLE */}
                    <div style={{ display: tab === "style" ? "block" : "none" }} className="space-y-5 ">
                        <div className="space-y-2 ">
                            <div className="text-sm font-semibold text-slate-900">
                                Customize elements
                            </div>
