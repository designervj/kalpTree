...
export const Ic = {
  ...
  Chevron: ({ open }) => (
    <svg className={cls("w-4 h-4 transition-transform", open && "rotate-180")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  Car: () => (
    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16H7m9.293-9H6l-3 6h18l-1-4.5H16.29" />
    </svg>
  ),
  Star: () => (
