      ...
      <CardContent className="pt-6 space-y-5">
        <div className="rounded-lg border bg-muted/20 p-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={headingFontFamily} onValueChange={(value) => setHeadingFontFamily(value)}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="text-xs text-muted-foreground">{headings.h1.scale}px</span>
            </div>
            <Slider
              value={[headings.h1.scale]}
              min={12}
              max={22}
              step={1}
