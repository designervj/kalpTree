...
import GetSingleAgency from "@/components/admin/agency/GetSingleAgency";
      ...
      <div className="w-full space-y-10">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-muted-foreground">
            Everything you need to manage website, branding, products &
            marketing.
          </p>
        </div>
                          ...
                          <div className="mt-3 flex flex-wrap items-center gap-2 rounded-md">
                            ...
                            {hasEmail ? (
                              ...
                              >
                                <Link
                                  href={
                                    site.setupEmailHref || "/admin/emails/setup"
                                  }
