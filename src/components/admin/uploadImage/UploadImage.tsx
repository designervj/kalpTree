...
import { UploadProgress, UploadResult } from './utilies/DirectS3UploadService';
import { UploadService } from './utilies/uploadService';
...
const UploadImage: React.FC<UploadImageProps> = ({
  ...
  // Clear selection
  const handleClear = () => {
    UploadService.cleanupPreview(selectedFile?.preview);
        ...
        {selectedFile ? (
          <div className="space-y-4">
            ...
            <div className="text-sm text-gray-600">
              ...
              <p>{UploadService.formatFileSize(selectedFile.size)}</p>
            </div>
          </div>
        ) : (
          <div className="space-y-4">
