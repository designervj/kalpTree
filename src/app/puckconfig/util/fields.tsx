import { DEFAULT_SIZING, SizingPanel } from "@/components/puckcomponents/CustomSIzing";
import { DEFAULT_SPACING, SpacingPanel } from "@/components/puckcomponents/CustomSpacing";
import { DEFAULT_BORDER, BorderPanel } from "@/components/puckcomponents/CustomBorder";
import { DEFAULT_LAYOUT, LayoutPanel } from "@/components/puckcomponents/CustomLayout";
import { DEFAULT_BOX_SHADOW, BoxShadowPanel } from "@/components/puckcomponents/CustomBoxShadow";
import { DEFAULT_TEXT, TextPanel } from "@/components/puckcomponents/CustomText";
import { DEFAULT_BACKGROUND, BackgroundPanel } from "@/components/puckcomponents/CustomBackground";
...
export const spacingFields = {
    ...
    render: (data: any) => {
        ...
        const safeValue = value ? { ...DEFAULT_SPACING, ...value } : DEFAULT_SPACING;
...
export const boxShadowFields = {
    ...
    render: (data: any) => {
        const { onChange, value } = data;
        const safeValue = value ? { ...DEFAULT_BOX_SHADOW, ...value } : DEFAULT_BOX_SHADOW;
...
export const backgroundFields = {
    ...
    render: (data: any) => {
        const { onChange, value } = data;
        const safeValue = value ? { ...DEFAULT_BACKGROUND, ...value } : DEFAULT_BACKGROUND;
