...
function MediaCard({
  ...
  return (
    <div className="group bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition">
      {/* Image preview with checkered transparency bg */}
      <div
...
export default function Page() {
  ...
  return (
   ...
   <div className="bg-gray-50 rounded-xl max-w-7xl mx-auto space-y-8">
      {/* ── Header ── */}
  

      {/* ── Tabs ── */}
      <div className="flex items-center gap-8 px-8 bg-white border-b border-slate-200 py-1 rounded-sm" >
