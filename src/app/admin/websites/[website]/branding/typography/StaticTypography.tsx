...
//     lines.push(
//       `  --bg-surface: ${mixHex(dark, "#FFFFFF", 0.08)}; /* Cards and containers */`,
//     );
//     lines.push(`  --text-main: #FFFFFF; /* Primary text */`);
//     lines.push(
//       `  --text-muted: ${mixHex("#FFFFFF", dark, 0.45)}; /* Secondary/muted text */`,
//     );
//     lines.push(
...
//         color:
//           mode === "light" ? mixHex(brand.dark, "#000000", 0.2) : "#FFFFFF",
